 ...
 */
final class Version20210305151414 extends AbstractMigration implements ContainerAwareInterface
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $path = $this->container->getParameter('kernel.project_dir').'/public/offer/'.SpecialOffersEnum::AVANTAGE_OFFER['file_name'];
